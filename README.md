...
[English README](README_EN.md) | [方法说明](docs/baseline_method.md) | [当前问题与参赛战略](docs/current_issues_and_strategy.md) | [官方评分代理（v1）](docs/official_proxy_evaluation.md) | [v1 实验记录](docs/experiments/official_evaluation_v1.md) | [v2 实验记录](docs/experiments/response_decomposition_v2.md) | [v3 实验记录](docs/experiments/response_loss_balance_v3.md) | [文档与真实数据勘误](docs/reproduction_errata.md)
